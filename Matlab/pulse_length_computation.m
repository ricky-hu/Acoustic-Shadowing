...
pl = pulse_length_tissue*depth/num_sample
...
depth = 100;
% selecting the segment near the focal region from the central RF line
num_sample = length(rf33);
window_size = 200;
num_lines = size(rf33,2); 
X2 = rf33(round(num_sample/2)-window_size:round(num_sample/2)+window_size,num_lines/2); 
...
pl2 = pulse_length_tissue2*depth/num_sample
% lag = 85 axial samples
