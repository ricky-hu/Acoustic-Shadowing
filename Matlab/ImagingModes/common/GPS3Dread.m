function data = GPS3Dread(filename)
% Reads the volume cpatured with the gps-tracked volume feature of
% Ultrasonix Sonix Touch.
%
% filename: The entire filename, including the path and extension of the
% volume. If the extension is '.gtv', the raw data with GPS locations are
% read into a structure. If the extension of the file is '.grv', the
% interpolated data is read into a three dimenional matrix.
%
% data: The volume data. It can be a 3D matrix or a structure with raw data
% and GPS locations and orientations, depending on the extension of the
% file.
%
% Copyright: Ultraosnix Medical Corporation, 2014
% Author: Hani Eskandari
%
